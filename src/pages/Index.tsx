...
const Index = () => {
  ...
  const handleGenerate = async (prompt: string, ytUrl: string, apiKey?: string, instructions?: string, enableAi?: boolean) => {
  ...
  return <div id="top" className="min-h-[100dvh] flex flex-col bg-cyber-black text-white overflow-x-hidden">
      <NavBar />
      
      <main className="flex-grow pt-16">
        {!generatedContent ? <div className="container mx-auto px-4 py-16 md:py-24">
          ...
          </div> : <div className="container mx-auto px-4 py-8 md:py-12">
            <GeneratedPage content={generatedContent} youtubeUrl={youtubeUrl} userApiKey={enableAiAgent ? userApiKey : undefined} aiInstructions={enableAiAgent ? aiInstructions : undefined} />
          </div>}
      </main>
